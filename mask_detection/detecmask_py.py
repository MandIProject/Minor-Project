...
prototxtPath = r'D:\\Minor_Project\\mask_detection\\deploy.prototxt.py'
weightsPath = r"D:\\Minor_Project\\mask_detection\\res10_300x300_ssd_iter_140000.caffemodel"
faceNet = cv2.dnn.readNet(prototxtPath, weightsPath)

# load the face mask detector model from disk
maskNet = load_model("D:\\Minor_Project\\mask_detection\\mask_detector.model")
...
while True:
	...
	cv2.imshow("FaceMask Detection -- press q to quit", frame)
